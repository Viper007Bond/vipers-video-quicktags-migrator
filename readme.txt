...
*This plugin is written by the same author as Viper's Video Quicktags.*

[Viper's Video Quicktags](https://wordpress.org/plugins/vipers-video-quicktags/) was a popular but no longer maintained plugin that made it easy to embed videos into your WordPress site. Since the plugin was originally written over 10 years ago, WordPress has added [native embed support](http://codex.wordpress.org/Embeds) which allows you to easily embed videos out of the box. Its functionality is far superior to that of the plugin and most people have switched to using it.
